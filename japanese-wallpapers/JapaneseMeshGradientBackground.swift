...
struct JapaneseMeshGradientBackground: View {
    ...
    var body: some View {
        MeshGradient(width: 3, height: 3, points: [
            ...
            colorScheme == .dark ? Color(red: 0.12, green: 0.06, blue: 0.12) : Color(red: 0.85, green: 0.80, blue: 0.85),
            colorScheme == .dark ? Color(red: 0.16, green: 0.08, blue: 0.16) : Color(red: 0.90, green: 0.85, blue: 0.90),
            colorScheme == .dark ? Color(red: 0.20, green: 0.10, blue: 0.20) : Color(red: 0.95, green: 0.90, blue: 0.95),
            
            colorScheme == .dark ? Color(red: 0.24, green: 0.12, blue: 0.24) : Color(red: 0.80, green: 0.75, blue: 0.80),
            colorScheme == .dark ? Color(red: 0.28, green: 0.14, blue: 0.28) : Color(red: 0.75, green: 0.70, blue: 0.75),
            colorScheme == .dark ? Color(red: 0.32, green: 0.16, blue: 0.32) : Color(red: 0.70, green: 0.65, blue: 0.70)
        ])
        .onAppear {
            startTimer()
        }
